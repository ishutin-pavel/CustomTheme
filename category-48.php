...
?>
	...
	<div class="row">
		...
		<?php
			$args_main = array( 'category' => 48, 'order'   => 'ASC','posts_per_page'=>-1, 
			'numberposts'=>-1  );
			...
			//print_r($posts_main);
				...
				<div>
				<img class="textPic textPicB" src="/img/small/tal-cepnaja-ruchnaja.jpg" alt="Таль ручная цепная" onclick="ppicSwith(this)">
<p>
