...
$args = array(
	'parent' => 0,
	'hide_empty' => 0,
	'exclude' => '1,57,58', // ID рубрики, которую нужно исключить
	'number' => '0',
	'orderby' => 'id',
	'order' => 'DESC',//DESC
	'pad_counts' => true
    ...
    <?php foreach ($catlist as $cat) : ?>
	    <div class="col-xl-3 col-lg-4 col-sm-6 col-6 whole_cart">
            <a href="<?php echo get_term_link($cat->slug, 'category'); ?>" class="cart">
                <ul>
                    <li style="background-image:url(<?php echo z_taxonomy_image_url($cat->term_id, 'full'); ?>);"><!--<img src="<?php /*echo z_taxonomy_image_url($cat->term_id, 'full');*/ ?>" alt="">--></li>
