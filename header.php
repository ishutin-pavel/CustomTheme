...
<head>
		...
		<?php wp_head(); ?>
		<noindex><script async src="https://stats.lptracker.ru/code/new/54263"></script></noindex>
</head>
<body>
...
<div class="container">
	<div class="row header-block">
		...
		<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-5">
			...
			<div class="logo">
				<a href="/">
						<img src="/wp-content/themes/CustomTheme/images/logo.png" alt="">
						<span>
								<ul>
										<li>ЗАВОД</li>
										<li>ГРУЗОПОДЪЕМНОГО</li>
										<li>ОБОРУДОВАНИЯ</li>
								</ul>
						</span>
				</a>
